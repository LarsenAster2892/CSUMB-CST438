...
public class AdministratorViewTimesheetActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Listener for the approve button. Button disabled at first.
        ...
        // Listener for the deny button. Button disabled at first.
    ...
    public void approve(View v)
    {
        ...
        // Call to async task to edit the timesheet. Only status field is changed.
